    ...
    <div className="relative @container">
      <h3 className="mb-4 text-xl font-light text-opacity-80">
        ...
        <small className="text-sm">
          Data updated: <RelativeTime date={new Date(dataUpdatedAt)} />
        </small>
      </h3>
