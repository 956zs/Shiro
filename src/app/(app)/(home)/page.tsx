      ...
      <TwoColumnLayout leftContainerClassName="mt-[120px] lg:mt-0 lg:h-[15rem] lg:h-1/2">
        ...
        >
          <small className="text-center">
            When the first satellite flew beyond the atmosphere, we thought we
            would one day conquer the universe.
          </small>
  ...
  return (
    <>
      <div className="center mt-28 flex flex-col">
        <div className="my-5 text-2xl font-medium">Navigation</div>
        <div className="mb-24 opacity-90">Want to explore elsewhere?</div>
